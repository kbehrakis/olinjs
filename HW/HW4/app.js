...
var getOrder = require('./routes/getOrder.js');
...
// GET/POST requests for ingredient actions
...
// GET/POST requests for order actions
app.get('/order', getOrder.chooseIngredients);
app.post('/checkbox', getOrder.checkbox);
app.post('/addNewOrder', getOrder.addNewOrder);

// GET/POST requests for kitchen actions
app.get('/kitchen', getOrder.listOrders);
app.post('/completeOrder', getOrder.completeOrder);
